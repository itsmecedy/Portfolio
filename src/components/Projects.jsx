...
export default function Projects() {
  return (
    <div id="projects">
      <div className=" max-w-[80rem] flex justify-center items-center mx-auto py-20 px-5  flex-col">
        <div className=" flex flex-col justify-start items-start w-full">
          <p class="bold uppercase font-bold text-lg text-blue-600 mb-4 lg:text-left">
            Projects
          </p>
          <p class=" font-semibold text-2xl tracking-tight mb-4 lg:text-left ">
            Each project is a unique piece of development
          </p>
        </div>
        {/* projects */}
        <div className="flex flex-col lg:flex-row mx-auto  pb-20">
          {/* left side */}
